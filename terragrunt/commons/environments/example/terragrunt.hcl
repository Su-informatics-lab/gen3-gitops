...
inputs = {
  ...
  hostname = "demo-gen3.rds-pla.net"

  # Networking
  vpc_cidr_block    = "10.148.0.0/20"
  peering_cidr      = "10.128.0.0/20"
  peering_vpc_id    = "vpc-0293e2917a84fa4c5"
  vpc_flow_logs     = false
  ...
  # Aurora configuration (not used in dev but kept for completeness)
  cluster_identifier                = "aurora-cluster-dev"
  cluster_instance_identifier       = "aurora-cluster-instance-dev"
  ...
  final_snapshot_identifier         = "aurora-cluster-snapshot-final-dev"
